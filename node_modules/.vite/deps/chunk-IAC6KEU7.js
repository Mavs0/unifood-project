...
var Tooltip = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _React$useState3 = React.useState(props.position || "right"), _React$useState4 = _slicedToArray(_React$useState3, 2), positionState = _React$useState4[0], setPositionState = _React$useState4[1];
  var _React$useState5 = React.useState(""), _React$useState6 = _slicedToArray(_React$useState5, 2), classNameState = _React$useState6[0], setClassNameState = _React$useState6[1];
  var _React$useState7 = React.useState(false), _React$useState8 = _slicedToArray(_React$useState7, 2), multipleFocusEvents = _React$useState8[0], setMultipleFocusEvents = _React$useState8[1];
  ...
  var createElement2 = function createElement3() {
    ...
    return React.createElement("div", _extends({
      ref: elementRef
    }, rootProps), React.createElement("div", arrowProps), React.createElement("div", _extends({
      ref: textRef
...
//# sourceMappingURL=chunk-IAC6KEU7.js.map
